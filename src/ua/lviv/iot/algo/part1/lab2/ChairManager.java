...
public class ChairManager {
    ...
    public static void main(String[] args) {
        ...
        manager.addChair(new FeedingTable(1, "wood", 100, 40, "John", 2));
        manager.addChair(new FeedingTable(2, "plastic", 50, 30, "Mary", 1));
        manager.addChair(new GameChair(1, "leather", 120, "Alex", 25, 100, 15));
        manager.addChair(new GameChair(2, "mesh", 80, "Kate", 20, 95, 10));
        manager.addChair(new OfficeChair(1, "leather", 120, "Alex", "executive", "leather", 45.0));
        manager.addChair(new OfficeChair(2, "mesh", 80, "Kate", "task", "fabric", 30.0));
        ...
        System.out.println(manager.searchByMaxWeight(100));
